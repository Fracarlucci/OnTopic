INSERT INTO UTENTE (Nome, Cognome, Username, Email, Password, Sale)
...
INSERT INTO POST (Testo, idTema, idUtente)
    VALUES  ('Le rose sono rosse, le viole sono blu, rondo è il miglior rapper d\'Italia', 1, 1),
            ...
            ('Voglio inziare a vedere i film di Tarantino, ma sono indeciso da quale iniziare, consigli?', 25, 3),
            ('Quanto costa mantenere un cane?', 27, 1),
            ('Ho un labrador che da poco ha fatto i cuccioli, qualcuno interessato?', 27, 2);
